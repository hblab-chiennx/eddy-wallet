...
export function Dialog({ open = true, title, description, icon, tone = "brand", parentOnly, children, confirmLabel, onConfirm, cancelLabel = "Cancel", onClose, style }: DialogProps) {
  if (!open) return null;
